...
public class AuthenticationRequestFactory extends OpenSamlAuthenticationRequestFactory {
	...
	@Value("${sp.service.oid:2.16.100.1.1.1.1.13.1.1.1}")
	...
	public String createAuthenticationRequest(Saml2AuthenticationRequest request) {
		...
		// auth.setAssertionConsumerServiceURL("https://eauth.egov.bg/test-sp-profile-high/login/saml2/sso/mock-idp");
