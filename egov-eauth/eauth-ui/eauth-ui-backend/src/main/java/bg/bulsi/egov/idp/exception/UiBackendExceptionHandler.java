...
@ControllerAdvice
public class UiBackendExceptionHandler extends ResponseEntityExceptionHandler{

/*
 *  -- CUSTOM Handlers--
 */

	@ExceptionHandler(value = { UiBackendException.class })
	public ResponseEntity<Object> handleException(UiBackendException ex, WebRequest request) {
