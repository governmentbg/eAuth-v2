...
import bg.bulsi.egov.idp.client.config.model.EidProvidersConfiguration.EidProviderConfig.ProviderAuthAttribute.Eid;
...
public class TestPropertyContext extends AbstractTestNGSpringContextTests {
	...
	private void testIdpObj() {
		...
		String attributeKey = id + "_" + EidProvidersConfiguration.EidProviderConfig.ProviderIdSuffix.USERNAME.name();
