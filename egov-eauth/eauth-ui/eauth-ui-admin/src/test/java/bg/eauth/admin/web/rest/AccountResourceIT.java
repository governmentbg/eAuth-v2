...
import bg.eauth.admin.domain.Authority;
import bg.eauth.admin.domain.User;
import bg.eauth.admin.repository.AuthorityRepository;
import bg.eauth.admin.repository.UserRepository;
import bg.eauth.admin.security.AuthoritiesConstants;
import bg.eauth.admin.service.MailService;
import bg.eauth.admin.service.UserService;
import bg.eauth.admin.service.dto.PasswordChangeDTO;
import bg.eauth.admin.service.dto.UserDTO;
import bg.eauth.admin.web.rest.errors.ExceptionTranslator;
import bg.eauth.admin.web.rest.vm.KeyAndPasswordVM;
import bg.eauth.admin.web.rest.vm.ManagedUserVM;
