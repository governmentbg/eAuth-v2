...
public class AuditResourceIT {
    ...
    @Autowired
    private AuditEventEntityRepository auditEventRepository;
    ...
    public void initTest() {
        ...
        auditEvent = new AuditEventEntity("application",SAMPLE_PRINCIPAL,SAMPLE_TIMESTAMP,SAMPLE_TYPE);
...
//        auditEvent.setAuditEventType(SAMPLE_TYPE);
    ...
    public void testPersistentAuditEventEquals() throws Exception {
        TestUtil.equalsVerifier(AuditEventEntity.class);
        AuditEventEntity auditEvent1 = new AuditEventEntity();
        auditEvent1.setId(1L);
        AuditEventEntity auditEvent2 = new AuditEventEntity();
