...
const audit = require('../../shared/util/structure/status-event-type.json');
...
export class AuditsComponent implements OnInit, OnDestroy {
  ...
  statuses = audit.eventTypes;
  originTypes = audit.originTypes;
  ...
  ngOnInit() {
    ...
    this.today();
    this.previousMonth();
    this.auditOrigin = 'application';
    this.auditEventType = 'AUTHENTICATION_SUCCESS';
    this.loadAll();
  }
