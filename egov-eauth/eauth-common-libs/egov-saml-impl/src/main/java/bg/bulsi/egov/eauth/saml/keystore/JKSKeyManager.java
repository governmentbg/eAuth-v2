...
public class JKSKeyManager implements KeyManager {
	...
	private Resolver<Credential, CriteriaSet> credentialResolver;
	 ...
	 * Available keys are calculated automatically.
	 *
	 * @param keyStore
	 *        key store to use
	 * @param passwords
	...
	/**
	 * Default constructor which instantiates a new KeyStore used to load all credentials. Available
	 * keys are calculated automatically.
	 *
	 * @param storeFile
	 ...
	 *        default key
	 */
	public JKSKeyManager(Resource storeFile, String storePass, Map<String, String> passwords,
			String defaultKey) {
	 ...
	 *
	 * @param keyStore
	 *        key store to load aliases from
	 * @return aliases
	 */
	 ...
	 *        file pointing to the JKS keystore
	 * @param storePass
	 *        password to open the keystore, or null for no password
	 * @param storeType
	 *        type of keystore
