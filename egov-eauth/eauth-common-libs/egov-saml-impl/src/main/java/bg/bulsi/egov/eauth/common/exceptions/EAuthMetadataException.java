 ...
 * @since 2.0.0
 */
public class EAuthMetadataException extends Exception {
    ...
    /**
     * Instantiates a new EAuthMetadataException engine exception.
     *
     * @param cause the cause (which is saved for later retrieval by the {@link #getCause()} method).  (A <tt>null</tt>
     * value is permitted, and indicates that the cause is nonexistent or unknown.)
     */
    public EAuthMetadataException(Throwable cause) {
        super(cause);
    }
     ...
     */
    public EAuthMetadataException(String errorMessage) {
        super(errorMessage);
    }
     ...
     * value is permitted, and indicates that the cause is nonexistent or unknown.)
     */
    public EAuthMetadataException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public EAuthMetadataException(String newErrorCode, String errorMessage) {
        super(errorMessage);
     ...
     * value is permitted, and indicates that the cause is nonexistent or unknown.)
     */
    public EAuthMetadataException(String newErrorCode, String errorMessage, Throwable cause) {
     ...
     */
    public EAuthMetadataException(String newErrorCode, String errorMessage, String newErrorDetail) {
        super(errorMessage);
        this.errorCode = newErrorCode;
